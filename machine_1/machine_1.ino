...
#define MAC_ID "A1"
#define ESP_SSID "Multiway" // Your network name here
#define ESP_PASS "a1b2c3d4e5" // Your network password here

#define HOST     "192.168.1.170" // Host (Server) name or IP address to contact
#define PAGE     "/time" // Web page to request (For GET request)
#define PORT     3000   // 80 = HTTP default port

char POST_HOST[] = "192.168.1.170";
...
int ping_interval = 2000; //Set ping interval time in miliseconds
...
void loop()
  {
    ...
    */
    ...
    /*
     * This code will send an event on every input change 
     * 
    ...
    */
    ...
    if(currentmillis - last_ping_time >= ping_interval)
        {
