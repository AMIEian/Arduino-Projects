...
class Nextion{
 ...
 public:	
  ...
  boolean setComponentColor(String component, String color);
  
  boolean setComponentPicture(String component, int pictureID);
  
  boolean setButtonPic(String button, int pictureID);
  
  boolean setProgressBar(String progressBar, int value);
