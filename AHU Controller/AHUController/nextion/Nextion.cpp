...
boolean Nextion::setComponentColor(String component, String color) {
  String componentColor = component + ".pco=" + color;//Set Component text
  sendCommand(componentColor.c_str());
  return ack();	
}

boolean Nextion::setComponentPicture(String component, int pictureID){
  String componentPicture = component + ".pic="+ String(pictureID);//Set Component text
  sendCommand(componentPicture.c_str());
  return ack();
}

boolean Nextion::setButtonPic(String button, int pictureID){
  String buttonPicture = button + ".pic="+ String(pictureID);//Set Component text
  sendCommand(buttonPicture.c_str());
  return ack();
}

boolean Nextion::setProgressBar(String progressBar, int value){
  String progress = progressBar + ".val="+ String(value);//Set Component text
  sendCommand(progress.c_str());
  return ack();
}
