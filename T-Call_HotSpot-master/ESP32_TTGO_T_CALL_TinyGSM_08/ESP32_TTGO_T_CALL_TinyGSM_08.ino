...
const char apn[]      = "airtelgprs.com";                  // GPRS - Your APN
const char gprsUser[] = "";                  // GPRS - User
const char gprsPass[] = "";                  // GPRS - Password
const char simPIN[]   = "";              // GPRS - SIM card PIN code, if any
...
void process(WiFiClient client) {
 ...
 /*           SerialMonitor.print("addr_start:  ");              
              ...
              String req_server = currentLine.substring(addr_start + 2, addr_end-4);//addr_midl);
